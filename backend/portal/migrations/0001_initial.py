# Generated by Django 5.0.6 on 2024-06-03 11:20
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to="portal/images/passport_size_photo",
                    ),
                ),
                (
                    "document_1",
                    models.FileField(
                        blank=True, null=True, upload_to="portal/images/document_1"
                    ),
                ),
                (
                    "document_2",
                    models.FileField(
                        blank=True, null=True, upload_to="portal/images/document_2"
                    ),
                ),
                (
                    "document_3",
                    models.FileField(
                        blank=True, null=True, upload_to="portal/images/document_3"
                    ),
                ),
                (
